...
groups <- list("1" = c("Abri Pataud", "El Rascaño", 
               ...
               "2" = c("Aurignac", "Gargas",
                       ...
                       "d'Engihoul"),
               "3" = c("Breitenbach", "Peskő Cave",
                       "Vindija Cave", "Wildscheuer"),
               "4" = c("Kvasice", "Labeko Koba", 
                       "Les Rois"),
               "5" = c("Le Trou Du Renard", "Abri Lartet/Gorge d'Enfer",
                       "Tuto de Camalhot", "Castanet", 
                       "Gatzarria", "Abri du Poisson"),
               "6" = c("Bockstein-Törle", "Grotte de Goyet",
                        "Trou Magrite", "Brassempouy"),
               "7" = c( "Göpfelsteinhöhle",  "Slatinice", 
                        "Grotte du Renne"),
               "8" = c( "El Castillo", "Trou al'Wesse", 
                        "Maisières-Canal"),
               "9" = c("Vogelherd","Hohle Fels",
                       "Geissenklösterle", "Le Terme Pialat", 
                       "Les Cottés", "Spy",  "Grottes de Fonds-de-Forêt"),
               "10" = c("Nová Dědina", "Menton/Grottes du Grimaldi",
                        "Solutré", "Žlutava", 
                        "Hornos de la Pena", "Otaslavice"),
               "11" = c("Cellier", "Blanchard", 
                        "La Ferrassie"),
               "12" = c("La Souquette", "Shelter Birów IV",
                        "Abri de Laussel"))
group_df <- 
  enframe(groups, 
          name = "group", 
