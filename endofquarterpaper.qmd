...
The Upper Paleolithic is characterized by a rise in early Homo sapiens, and a decline for other hominids. During this time, we see a rise in organized settlements, more complex social organizations, and more advanced tool-making across Europe. One of the most distinctive qualities of the Upper Paleolithic is the large rise in artwork available from that era, both parietal and otherwise. Considered to be the starting point of the Upper Paleolithic, the Aurignacian technocomplex is commonly linked to the dispersal of Homo sapiens across Western Eurasia, and is characterized by certain lithic and osseus markers [@Tejero_Grimaldi_2015; @Tartar_2012].


We still lack a complete knowledge of the cultural diversity and movement patterns of the early modern humans from this era, despite a great deal of research into the subject. In this paper, we analyze the distribution and variation of geometric sign types found on mobile artefacts from the Upper Paleolithic in Europe during the Aurignacian technocomplex. The basis of this analysis is the idea that variations on signs can serve as an indicator of group membership and cultural similarity. This approach is supported by both ethnographic evidence throughout history, as well as similar archaeological studies done on ornamental and parietal art [@Pereira_Manen_2023; @Sauvet_2018; @Rigaud_dErrico_Vanhaeren_2015; @baker2024evidence; @Lycett_2019; @Vanhaeren_d]. In this study, we use our analyses to attempt to answer the following questions: Do identifiable and relevant patterns of cultural groups exist in the data, and if so, what can they tell us about the patterns of diversity and movement among Upper Paleolithic hominids?

<!--SC: I'm still having a difficult time figuring out just how to end this paragraph - you mentioned that I should have a research question ending in a question mark, but I'm struggling to figure out how to phrase it in a way that is appropriately formal  -->

# Background

Our understanding of the patterns of cultural and genetic diversity among the hominids of the Upper Paleolithic remains incomplete. Previous works have performed various cluster analysis methods upon variations in artefacts to represent and understand patterns of groups and cultural diversity. The studies have primarily relied upon personal ornamentation and parietal art, with few taking mobile objects into account.

Multivariate analyses of Gravettian beads from burial and occupation sites in Europe suggests an east to west cline of nine cultural groups [@baker2024evidence]. Seriation analysis, PCoA, and network analysis are used to identify the groups. The geographically discrete clusters identified encompass the regions of eastern, northwestern and central Europe, the northern and southern Iberian peninsula, southern and northern Italy, and the eastern and Western Mediterranean regions.

Similar analyses performed upon bead work patterns from the Aurignacian technocomplex as an indicator for linguistic diversity identify fourteen geographically cohesive clusters [@Vanhaeren_d]. Specifically, the groups are identified using seriation, correspondence and GIS analyses. The clusters identified are geographically discrete and sweep counter-clockwise throughout western France, northern Spain, the Pyrenees, and the Mediterranean region.
...
signbase_3000 <- signbase_years_cal
signbase_3000$site_name <- signbase_years$site_name
signbase_3000 <- signbase_3000 %>% 
  filter(MedianBP < 30000)
...
The isolation-by-distance framework proposes that cultural difference can be primarily explained by geographic distance. Assuming that this framework is true, we would hypothetically see patterns of cultural features of Upper Paleolithic hominids that are dispersed according to geography. Conversely, if geographic distance cannot account for the distribution of the sign types, we would have to assume that other factors are at play, namely, movement of groups or the creation of social networks.
...
In this paper, we set out to ask if identifiable and relevant patterns existed in the data, and if so, what could they tell us about the patterns of diversity and movement among Upper Paleolithic hominids?
