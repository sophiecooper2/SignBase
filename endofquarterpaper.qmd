...
---
# Introduction
<!-- swap around sentences-->
One distinctive quality of the Upper Paleolithic is the large rise in artwork, both parietal and mobile. During this period, we also see a rise in more complex social organizations across Europe [@Boyd_Silk_2020] coupled with biological evolution. Archaeologists have frequently relied upon that artwork as a proxy for cultural difference in order to understand these shifting patterns of social organization and diversity 

 <!-- change citations maybe -->
[@McDonald_Harper_2016; @Pereira_Manen_2023; @Fuentes_Lucas_Robert_2019].

<!-- mention upper paleolithic in last sentence of above paragraph -->
...
In this paper, we analyze the distribution and variation of geometric sign types found on mobile artefacts from the Upper Paleolithic in Europe across the subperiods of the Aurignacian period. 

<!-- The basis of this analysis is the idea that variations in signs can serve as an indicator of group membership and cultural similarity.--> 

This approach is supported by ethnographic and historical evidence [@texier2010howiesons; @Hodder1979; @Hodder1977; @Vanhaeren_2005] as well as similar archaeological studies of ornamental and parietal art [@Pereira_Manen_2023; @Sauvet_2018; @Rigaud_dErrico_Vanhaeren_2015; @baker2024evidence; @Lycett_2019; @Vanhaeren_d; @McDonald_Harper_2016].

<!-- read above literature to confirm relevance--> 

# Background

Social organization dynamics have previously been explored using cluster analysis methods upon variations in artefacts to represent and understand patterns of groups and cultural diversity, and have primarily relied upon personal ornamentation and parietal art.

For example, multivariate analyses of Gravettian beads suggests an east to west cline of nine cultural groups [@baker2024evidence]. 

The data set consisted of 134 discrete beads types from both burial and occupation sites, as distinguished by shape and material. Seriation analysis, PCoA, and network analysis were used to identify the groups from the bead data. 

The geographically discrete groups identified encompassed the regions of eastern, northwestern and central Europe, the northern and southern Iberian peninsula, southern and northern Italy, and the eastern and Western Mediterranean regions. 

<!-- reread paper, make sure that last sentence accurately describes results  -->
The isolation-by-distance hypothesis, which proposes that cultural difference can be primarily explained by geographic distance, is tested using a Mantel test, determining that geographic distance cannot solely account for the bead distribution.

<!-- Add connector between baker and vanharen paragraphs, add more detail about Vanharen methods-->
