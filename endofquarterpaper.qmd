...
```{r}
#| label: fig-aur-table
#| fig-cap: "Table of data on Aurignacian periods [@Banks_dErrico_Zilhao_2013;  @Shao_Limberg_Klein_Wegener_Schmidt_Weniger_Hense_Rostami_2021; @Sanz-Royo_Terlato_Marín-Arroyo_2024, @Chu_Richter_2020; @Fletcher_Sánchez],"
library(knitr)
library(tidyverse)
library(readxl)
