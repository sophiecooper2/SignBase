...
Variation in diversity of sign types among sites may be representative of variation in social arrangement or social context. Despite the tendency to conceive of hunter-gatherers as monolithic, previous studies have established a potential for variation in hunter-gatherer social arrangements [@Finlayson_Warren_2017; @Riches_1995; @Price_Brown_1985; @Lane_2017]. @Bloch_1977 drew upon ethnographic studies of hunter-gatherers to theorize a correlation between the amounts of social structure, instituted hierarchy, and ritual communication within a society. @Conkey_1985 built upon that theorized correlation to argue that artwork and other forms of material culture can serve as a form of ritual communication, and that an increase in diversity within those material cultures may suggest more elaborate or complex social contexts. If the signs served functions of ritual communication, then changes in sign diversity from site to site, particularly the larger grouping structure of broader versus restricted signs, may be representative of two different social arrangement types, such as, for example, a more hierarchical structure versus a less hierarchical structure.
